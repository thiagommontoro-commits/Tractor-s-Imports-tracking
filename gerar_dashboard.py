...
TRANSLATIONS = {
    "pt": {
        ...
        "dashboard_subtitle": "Análise de dados",
        ...
        "donut_filter_label": "Filtros Cortes Exclusivos da Rosca:",
    ...
    "en": {
        ...
        "dashboard_subtitle": "Data Analysis",
        ...
        "donut_filter_label": "Donut Chart Exclusive Filters:",
        "all_years": "All Years",
...
def criar_fig_pais(df_agg):
    ...
    fig.update_layout(
        title_text=TRANSLATIONS['pt']['chart1_title'], title_x=0.5, # Já estava correto, mantido por clareza
        updatemenus=[dict(active=0, buttons=list([
            dict(label=TRANSLATIONS['pt']['fob_value'], method="update", args=[{"visible": [True, False, False]}, {"yaxis.title": TRANSLATIONS['pt']['total_fob_value']}]), # Já estava correto
            dict(label=TRANSLATIONS['pt']['cif_value'], method="update", args=[{"visible": [False, True, False]}, {"yaxis.title": TRANSLATIONS['pt']['total_cif_value']}]), # Já estava correto
            dict(label=TRANSLATIONS['pt']['quantity'], method="update", args=[{"visible": [False, False, True]}, {"yaxis.title": TRANSLATIONS['pt']['total_quantity_axis']}]) # Já estava correto
